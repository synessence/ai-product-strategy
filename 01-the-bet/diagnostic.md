...
## Platform Exposure: Score 5 / 5
Encroachment Risk: Limited due to priviliged access to proprietary systems and data, and PHI nature of data.

Structural Defense: 

Platform attacker: none are granted access to PHI at this time

## Top Vulnerability
Risk: a competitor succeeds in integrating to additional systems (MCP, etc.) that improves CX beyond our capability.

Opportunity cost: Not embracing conversational UI will give competitors an opportunity to provide better CX.
